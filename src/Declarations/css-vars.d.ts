declare module "Styles/Exports.module.scss" {
  class CSSVars {
    ...
    public static progressLowDark: string;
    public static progressMidLight: string;
    public static progressMidDark: string;
    public static progressHighLight: string;
    public static progressHighDark: string;
  }

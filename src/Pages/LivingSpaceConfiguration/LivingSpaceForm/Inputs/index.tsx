...
import type { Controller } from "Layouts/PropertyConfiguration";
import { PropertyConfigurationDropdown } from "Layouts/PropertyConfiguration";
...
interface Props extends LivingSpace {
  editing: boolean;

...
export type AmenityReservation = {
  ...
  end: Scalars['ISODate']['output'];
  id: Scalars['Int']['output'];
  person: EntitySnapShot;
  start: Scalars['ISODate']['output'];
};
...
export type MutationCreateAmenityReservationArgs = {
  ...
  end: Scalars['ISODate']['input'];
  organizationId: Scalars['Int']['input'];
  personId: Scalars['Int']['input'];
  propertyId: Scalars['Int']['input'];
  start: Scalars['ISODate']['input'];
};
...
export type AmenityFragmentFragment = { __typename?: 'Amenity', id: number, name: string, open: string, price: string, billed: BillFrequency, close: string, capacity: string, propertyId: number, images: Array<{ __typename?: 'GradiumImage', id: number, url: string }>, floorPlans: Array<{ __typename?: 'GradiumImage', id: number, url: string }> };

...
export type ListPeopleQuery = { __typename?: 'Query', listPeople: { __typename?: 'PaginatedPeople', cursor: number, list: Array<{ __typename?: 'Person', name: string, userId: number }> } };

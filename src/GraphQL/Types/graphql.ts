...
export type MutationCreateManagementTaskArgs = {
  ...
  images: Array<GradiumImageInput>;
  organizationId: Scalars['Int']['input'];
  priority: ManagementTaskPriority;
...
export type ManagementTaskFragmentFragment = { __typename?: 'ManagementTask', id: number, priority: ManagementTaskPriority, createdAt: any, title: string, description: string, status: ManagementTaskStatus, images: Array<{ __typename?: 'GradiumImage', id: number, url: string }>, createdBy: { __typename?: 'Person', id: number, name: string }, assignedTo?: { __typename?: 'StaffMember', id: number, name: string } | null, expenses: Array<{ __typename?: 'Expense', id: number, createdAt: any, cost: string, title: string, description: string, attachments: Array<{ __typename?: 'GradiumImage', id: number, url: string }> }> };
...
export type CreateManagementTaskMutationVariables = Exact<{
  ...
  status: ManagementTaskStatus;
  priority: ManagementTaskPriority;
  images: Array<GradiumImageInput> | GradiumImageInput;
  assignedToId?: InputMaybe<Scalars['Int']['input']>;
}>;
